...
resource "azapi_update_resource" "datafactory_parameters" {
...
resource "azurerm_private_endpoint" "adf_pe" {
  ...
  custom_network_interface_name = "nic-pep-${local.adf_name}"
...
resource "azurerm_data_factory_linked_service_azure_databricks" "link_dbw" {
  name                       = "Databricks"
  data_factory_id            = azurerm_data_factory.datafactory.id
  adb_domain                 = "https://${"module.dbw.workspace_url"}"
  msi_work_space_resource_id = "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Databricks/workspaces/workspaceValue"
