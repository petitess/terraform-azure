  ...
  nsg = [
    ...
    },
    {
      ...
      security_rule = [
        ...
        #   priority                   = 500
        #   protocol                   = "*"
        #   source_address_prefixes    = concat(azurerm_subnet.subnets["snet-app"].address_prefixes, azurerm_subnet.subnets["snet-func-flex"].address_prefixes)
        #   source_port_range          = "*"
        # },
        {
          access                     = "Deny"
    ...
    {
      name       = "nsg-snet-func-flex"
      subnetname = "snet-func-flex"
      security_rule = [
        {
          access                     = "Allow"
          destination_address_prefix = "VirtualNetwork"
